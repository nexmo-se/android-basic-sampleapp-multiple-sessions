...
public class MainActivity extends AppCompatActivity implements EasyPermissions.PermissionCallbacks {
    ...
    private Session.SessionListener sessionListener = new Session.SessionListener() {
        ...
        public void onStreamReceived(Session session, Stream stream) {
            ...
            Log.d(TAG, "onStreamReceived: xxx getOutputMode " + AudioDeviceManager.getAudioDevice().getOutputMode());
    ...
    private SubscriberKit.SubscriberListener subscriberListener = new SubscriberKit.SubscriberListener() {
        ...
        public void onConnected(SubscriberKit subscriberKit) {
            ...
            //Log.d(TAG, "onConnected: xxx getOutputMode " + AudioDeviceManager.getAudioDevice().getOutputMode());
        }
    ...
    private View.OnClickListener clickListener = new View.OnClickListener() {
        ...
        public void onClick(View v) {
            switch (v.getId()) {
                case R.id.connectSession:
                    if (session == null) {
                        initializeSession(OpenTokConfig.API_KEY,
                                OpenTokConfig.SESSION_ID,
                                OpenTokConfig.TOKEN);
                    }
                    break;
                case R.id.connectSession2:
                    if (session == null) {
                        initializeSession(OpenTokConfig.API_KEY,
                                OpenTokConfig.SESSION_ID2,
                                OpenTokConfig.TOKEN2);
                    }
                    break;
                case R.id.disconnectSession:
                    if (publisher != null) {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        findViewById(R.id.connectSession).setOnClickListener(clickListener);
        findViewById(R.id.disconnectSession).setOnClickListener(clickListener);
        findViewById(R.id.connectSession2).setOnClickListener(clickListener);
